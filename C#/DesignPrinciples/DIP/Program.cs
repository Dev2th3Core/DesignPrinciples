...
namespace DIP
{
    internal class Program
    {
        ...
        {
            Console.WriteLine("========= DIP DEMO START =========\n");
            ...
            var leaveRepository = new InMemoryLeaveRepository();

            var leaveStrategyList = new List<ILeaveManager>
            {
                new PermanentLeaveManager(leaveRepository),
                new ContractLeaveManager(leaveRepository),
                new InternLeaveManager(leaveRepository)
            };
            ...
            {
                new PermanentAttendanceManager(attendanceRepository),
                new ContractAttendanceManager(attendanceRepository),
                new InternAttendanceManager(attendanceRepository)
            };
